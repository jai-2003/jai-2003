<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Sanjaikannan%20P&fontSize=42&fontColor=fff&animation=twinkling&fontAlign=50" width="100%"/>
...
|:---|:---|:---|
| [**E-Commerce Website**](https://github.com/sanjaikannan1525) | HTML, CSS, JavaScript | Responsive product catalog with shopping cart, dynamic DOM manipulation, local storage, and a streamlined checkout experience |
| [**Portfolio Website**](https://github.com/sanjaikannan1525) | React.js, Tailwind CSS | Personal portfolio featuring About Me, Projects, Skills & Contact sections — clean, responsive, and component-based |
